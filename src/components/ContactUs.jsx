      ...
      <div className="flex flex-col space-y-8 justify-between">
        ...
        <div className="space-y-4 md:space-y-6  font-poppins text-white">
          ...
          <div className="flex  cursor-pointer space-x-4 items-center">
            ...
            <a href="https://mail.google.com/mail/u/0/?tab=rm#inbox?compose=GTvVlcSKkVPxxskjRnKHLCLFZMQgZVkDJsflCSVtBwhmlgZcVjBkljKQNcfQftxRGVbLqjDGsXcQg" target="_blank" className="xs:text-lg text-[14px]">Joytechtechnologies@gmail.com</a>
          </div>
